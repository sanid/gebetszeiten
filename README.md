...
Aladhan API: Für Gebetsdaten und Hijri-Kalender.

Nominatim (OpenStreetMap): Für Geocoding und Ortssuche.

ipwho.is: Als Fallback für die Standorterkennung.

🚀 Installation & Nutzung

Da die Anwendung keine Build-Tools (wie Webpack oder Vite) benötigt, ist die Installation extrem einfach:

Repository klonen:

git clone [https://github.com/dein-username/gebetszeiten-app.git](https://github.com/dein-username/gebetszeiten-app.git)


Starten:
Öffne einfach die Datei index.html in einem beliebigen modernen Webbrowser.

Deployment

Die App kann sofort auf jedem statischen Hoster bereitgestellt werden (z.B. GitHub Pages, Vercel, Netlify), da sie nur aus einer HTML-Datei besteht.

📸 Screenshots

(Hier könntest du Screenshots deiner App einfügen)
